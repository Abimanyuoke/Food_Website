...
const Hero = () => {
  ...
  return (
    <div style={bgImage} className='min-h-[632px] sm:min-h-[640px] bg-gray-100 dark:bg-gray-950 dark:text-white duration-200 flex justify-center items-center'>
        <div className='container pb-8 sm:pb-0'>
            <div className='grid grid-cols-1 sm:grid-cols-2'>
                ...
                <div className='flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1'>
                    ...
                    <div>
                    <button className='px-4 py-2 text-white bg-gradient-to-r from-primary to-secondary rounded-full hover:scale-105 duration-200'>Order Now</button>
                    </div>
                </div>
                {/* Image section  */}
